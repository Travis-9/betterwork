...
export function JobsPage() {
  ...
  return <div className="jobs-page">
    ...
    <footer className="jobs-footer"><Link className="jobs-footer-brand" href="/nl">ConnectSu</Link><span>© 2026 ConnectSu</span><nav aria-label="Footer navigation"><Link href="/terms">Terms of Service</Link><Link href="/privacy">Privacy Policy</Link><Link href="/contact">Contact Us</Link><Link href="/careers">Careers</Link></nav></footer>
  </div>;
}